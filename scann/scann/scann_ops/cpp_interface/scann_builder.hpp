...
class ScannBuilder {
 public:
  ...
  ScannBuilder& Tree(size_t num_leaves, size_t num_leaves_to_search,
                     ...
                     size_t training_iterations = 12, bool spherical = false,
                     bool quantize_centroids = false, bool random_init = true);
  ...
  research_scann::ScannSearcher Build();
